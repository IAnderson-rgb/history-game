                ...
                try
                {
                    ...
                    if (exit == false)
                    {
                        ...
                        while (isUserwrong)
                        {
                            ...
                            if (readyToPlay.ToLower() == "yes") //|| readyToPlay.ToLower() == "1" Place this inside if statement when ready.
                            {
                                Console.WriteLine();
                                Console.Clear();
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("\n\n|Press Q then Enter quit the game || Press Enter to restart game|");
