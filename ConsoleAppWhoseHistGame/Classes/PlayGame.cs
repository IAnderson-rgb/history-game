...
namespace ConsoleAppWhoseHistGame.Classes
{
    public class PlayGame
    {
        ...
        /// <summary>
        /// Gives the date the user choses to play. Reads in historical data from a txt file based on the date given. Reverses the order of the words in the txt file. Creates an answers list of the original word order.
        /// </summary>
